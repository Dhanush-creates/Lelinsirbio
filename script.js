...
function updateProfilePhotoOverlay() {
    const profilePhoto = document.getElementById('profilePhoto');
    const overlay = profilePhoto.querySelector('.profile-overlay');
    
    if (editMode) {
        overlay.textContent = '📷 Click to Upload Photo';
        profilePhoto.onclick = uploadProfilePhoto;
    } else {
        overlay.textContent = '🔒 Login to upload your professional photo';
        profilePhoto.onclick = () => showNotification('Please login first to upload photos!', 'info');
    }
}
...
function uploadProfilePhoto() {
    if (!editMode) {
        showNotification('Please enter edit mode first to upload photos!', 'error');
        return;
    }
...
function updateProfilePhoto() {
    ...
    if (profilePhotoData) {
        ...
        profilePhoto.innerHTML = `
            ...
            <div class="profile-overlay">
                ${editMode ? '📷 Click to Upload Photo' : '🔒 Login to upload your professional photo'}
            </div>
        `;
...
document.addEventListener('DOMContentLoaded', function() {
    updateProfilePhotoOverlay();
    showNotification('🔒 Secure Portfolio: Click "LELIN" to login and manage photos!', 'info');
});
